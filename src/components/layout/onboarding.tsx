...
const steps = [
  ...
  },
  {
    ...
    description:
      "Zero allows you to chat with your inbox, and take actions on your behalf.",
    video: "https://assets.0.email/step2.gif",
  },
  {
    title: "AI Compose & Reply",
    description:
      "Our AI assistant allows you to write emails that sound like you.",
    ...
    description: (
      <>
        <span className="text-muted-foreground mb-4">
          We&apos;re excited to bring these powerful features to all users very
          soon!
        </span>
      </>
    ),
...
export function OnboardingDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="bg-background mx-auto w-full max-w-[90%] rounded-xl border p-0 ring-5 ring-gray-100/30 sm:max-w-[690px] dark:bg-[#111111]">
...
export function OnboardingWrapper() {
  ...
  return (
    <OnboardingDialog open={showOnboarding} onOpenChange={handleOpenChange} />
  );
}
